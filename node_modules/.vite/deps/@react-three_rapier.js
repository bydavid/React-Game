import {
  ...
  pI,
  qA
} from "./chunk-4MCVFCBB.js";
import {
  VertexNormalsHelper,
  mergeVertices
} from "./chunk-2GROV6CN.js";
import {
  useFrame,
  useThree
} from "./chunk-J7OOJ4WY.js";
import {
  BufferAttribute,
  DynamicDrawUsage,
  Euler,
...
var createColliderFromOptions = (options, world, scale, rigidBody) => {
  ...
  const desc = NI[options.shape](...scaledArgs);
  ...
  (0, import_react.useEffect)(() => {
    ...
    (_collidersRef$current = collidersRef.current) === null || _collidersRef$current === void 0 ? void 0 : _collidersRef$current.forEach((collider) => {
      ...
      if (hasCollisionEvent && hasContactForceEvent) {
        collider.setActiveEvents(hA.COLLISION_EVENTS | hA.CONTACT_FORCE_EVENTS);
      } else if (hasCollisionEvent) {
        collider.setActiveEvents(hA.COLLISION_EVENTS);
      } else if (hasContactForceEvent) {
        collider.setActiveEvents(hA.CONTACT_FORCE_EVENTS);
      }
...
var applyAttractorForceOnRigidBody = (rigidBody, {
  object,
  strength,
  range,
  ...
  if (distance < range) {
    ...
    let isRigidBodyInCollisionGroup = collisionGroups === void 0 ? true : false;
    if (collisionGroups !== void 0) {
...
var Attractor = (0, import_react.memo)((props) => {
  const {
    position = [0, 0, 0],
    strength = 1,
    range = 10,
    type = "static",
    gravitationalConstant = 6673e-14,
    collisionGroups
  } = props;
  const {
    attractorStates
...
var importRapier = async () => {
  let r = await import("./rapier.es-T7ABY4L7.js");
  await r.init();
  return r;
};
var Physics = ({
  ...
  const eventQueue = useConst(() => new pI(false));
  const attractorStates = useConst(() => /* @__PURE__ */ new Map());
  ...
  const getSourceFromColliderHandle = (0, import_react.useCallback)((handle) => {
    ...
    if (world) {
      ...
      const rigidBody = rigidBodyHandle !== void 0 ? world.getRigidBody(rigidBodyHandle) : void 0;
  ...
  const step = (0, import_react.useCallback)((dt) => {
    ...
    const interpolationAlpha = timeStepVariable || !_interpolate || _paused ? 1 : steppingState.accumulator / _timeStep;
...
function mapsEqual(map1, map2) {
  ...
  for (var [key, val] of map1) {
    ...
    if (testVal !== val || testVal === void 0 && !map2.has(key)) {
      return false;
    }
  }
  return true;
}
var AttractorHelper = (props) => {
  const {
    scene
  } = useThree();
  const ref = (0, import_react.useRef)(null);
  const normalsHelper = (0, import_react.useRef)();
  const color = props.strength > 0 ? 255 : 16711680;
  (0, import_react.useEffect)(() => {
    if (ref.current) {
  ...
  return import_react.default.createElement("mesh", {
    ref,
    position: props.object.position,
    frustumCulled: false
  }, import_react.default.createElement("sphereGeometry", {
    args: [0.2, 6, 6]
  }), import_react.default.createElement("meshBasicMaterial", {
    color,
    wireframe: true
  }));
};
var Debug = (0, import_react.memo)(() => {
  ...
  const ref = (0, import_react.useRef)(null);
  const [attractors, setAttractors] = (0, import_react.useState)([]);
  const currMap = (0, import_react.useRef)(/* @__PURE__ */ new Map());
  useFrame(() => {
  ...
  return import_react.default.createElement("group", null, import_react.default.createElement("lineSegments", {
    ...
    color: 16777215,
    vertexColors: true
  }), import_react.default.createElement("bufferGeometry", null)), attractors.map((attractor, i) => import_react.default.createElement(AttractorHelper, _extends({
...
export {
  ...
  MeshCollider,
  Physics,
  MI as RapierCollider,
  FA as RapierRigidBody,
  RigidBody,
  RoundCuboidCollider,
  TrimeshCollider,
  interactionGroups,
