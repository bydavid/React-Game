 ...
 export function BlockSpinner({ position = [ 0, 0, 0 ] })
{
    ...
    return <group position={ position }>
        ...
        <RigidBody ref={ obstacle } type='kinematicPosition' position={ [ 0, 0.3, 0 ] } restitution={ 0.2 } friction={ 0 }> {/* restitution allows bounce off of, friction 0 so it doesn't slow/stop the marble */}
...
export function BlockEnd({ position = [ 0, 0, 0 ] })
{
    ...
    return <group position={ position }>
        ...
        <RigidBody ref = { obstacle } type='kinematicPosition' colliders="hull" position={ [ 0, 0.25, 0 ] } restitution={ 0.2 } friction={ 0 }>
